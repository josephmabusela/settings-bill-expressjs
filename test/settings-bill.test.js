...
describe('settings-bill', function(){
    ...
    it('should calculate the right totals', function(){
        ...
        assert.equal(2.35.toFixed(2), settingsBill.totals().smsTotal);
        assert.equal(3.35.toFixed(2), settingsBill.totals().callTotal);
        assert.equal(5.70.toFixed(2), settingsBill.totals().grandTotal);
    ...
    it('should calculate the right totals for multiple actions', function(){
        ...
        assert.equal(4.70.toFixed(2), settingsBill.totals().smsTotal);
        assert.equal(6.70.toFixed(2), settingsBill.totals().callTotal);
        assert.equal(11.40.toFixed(2), settingsBill.totals().grandTotal);
